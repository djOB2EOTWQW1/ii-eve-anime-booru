...
// Bundled image downloader with Referer/User-Agent support. Some booru previews
// (gelbooru) require a Referer header; the host shell's ImageDownloaderProcess
// may not support it (e.g. upstream ii-vynx), so the extension ships its own.
Process {
    id: root
